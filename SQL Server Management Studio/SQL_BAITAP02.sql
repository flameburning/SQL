...
--BAI01:VIẾT TRUY VẤN LỌC VÀ SẮP XẾP DỮ LIỆU
...
SELECT MaSV,[Họ và tên]=HoSV+''+TenSV, HocBong
FROM SinhVien
ORDER BY MaSV ASC
GO 
...
SELECT [Họ và tên]=HoSV+''+TenSV,NgaySinh,HocBong
FROM SinhVien
...
SELECT [Họ và tên]=HoSV+''+TenSV,NgaySinh,Phai
FROM SinhVien
...
SELECT MaKH,TenKH
FROM Khoa
WHERE TenKH LIKE N'%N'
GO

--8. Liệt kê những sinh viên mà họ có chứa chữ Thị. 
SELECT [Họ và tên]=HoSV+''+TenSV
FROM SinhVien
